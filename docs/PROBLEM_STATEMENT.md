...
Verbatim as provided from the SIH portal on 18 Sept 2026. Only text-encoding damage was repaired
(curly quotes and dashes that had become "â€™", "â€”"); no words were changed.
...
### The On-Device Workflow

Dead reckoning and GNSS fusion algorithms are hybrid. Complex training happens in the cloud/desktop apriori, while inference happens on the smartphone.
